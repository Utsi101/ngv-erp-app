...
async function main() {
  ...
  const myCompany = await prisma.companyProfile.create({
    data: {
      companyName: 'Bengal Leather Exports Private Limited',
      iecCode: '0123456789',
      adCode: '76543210987654',
      gstin: '19AAACB1234C1Z5',
      lutNumber: 'AD190426000000X',
      lutExpiryDate: new Date('2027-03-31T00:00:00Z'),
    },
  });
